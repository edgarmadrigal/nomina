...
Modulo = {
    ...
    , fnObtenerDatos: function (fechaInicio,fechaFin) {
        $("#relacionSolicitudes").css("display", "none");
        $(".loadTable").css("display", "block");
        var varURL = Modulo.baseurl + "relacionSolicitudesController/consulta";
        /**Ajax */
        $.ajax({
            url: varURL,
            type: 'post',
    ...
    , fnConstruitTabla: function () {
        table=$('#relacionSolicitudes').DataTable({
        ...
        $("#relacionSolicitudes").css("display", "inline-table");
