...
Modulo = {
    ...
    datosTabla: []    
    //Obtiene los datos
    , fnObtenerDatos: function (fechaInicio,fechaFin,em,fechaAplicacion) {
        ///$("#costo137").css("display", "none");
        ///$(".loadTable").css("display", "block");
        var varURL = Modulo.baseurl + "controllerDISPERSARCROM/exportar";
        /**Ajax */
        $.ajax({
            url: varURL,
            type: 'post',
           ...
           // $("#costo137").css("display", "inline-table");
           // $(".loadTable").css("display", "none");
            //Modulo.datosTabla=data;
 
            var a = document.createElement('a'); 
            var file_name = "DISPERSARCROM_"+$('#planta option:selected').html()+fechaFin;
            a.href =  window.location.origin +"/nomina/DISPERSARCROM.txt";
...
var buttonCommon = {
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '#buscar', function (e) {
            ...
            Modulo.fnObtenerDatos(fechaInicio,fechaFin,empresa,fechaAplicacion);
        });
