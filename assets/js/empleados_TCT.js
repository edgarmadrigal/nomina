...
function editar(id_edit) {
    ...
    $.ajax({
        url: base_url+'EmpleadosController_TCT/consulta',
        type: 'post',
        dataType: 'json',
        data: {
            id: id_edit
...
function eliminar(id_delete,empleado){            
    ...
    .then((willDelete) => {
        if (willDelete) {
            $.ajax({
                url:  base_url+'EmpleadosController_TCT/delete',
                type: 'post',
                dataType: 'json',
                data: {
                    id: id_delete
...
table=$('#example').DataTable( {
    ...
    ajax: {
        type: "POST",
        url: base_url+'EmpleadosController_TCT/consulta_empleado',
...
$(document).on('click', '#btn_guardar', function (e) {
    ...
    if(validar()){
        ...
        if(id>0){
            ///GUARDAR EDICION
            $.ajax({
                url: base_url+'EmpleadosController_TCT/edit',
                type: 'post',
                dataType: 'json',
                data: {
                    'id': id
                ...
                if (data) {
                    ...
                    swal({
                        ...
                        .then((value) => {
                            window.location.assign( base_url+'EmpleadosController_TCT');
                        });
                }
            });
            ...
            ///GUARDAR NUEVO        
            $.ajax({
                url: base_url+'EmpleadosController_TCT/insert',
                type: 'post',
                dataType: 'json',
                data: {
                     'NUMERO'               : NUMERO
