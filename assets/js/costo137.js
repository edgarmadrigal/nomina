...
Modulo = {
    ...
    , fnObtenerDatos: function (fechaInicio,fechaFin,em) {
        ...
        var varURL = Modulo.baseurl + "controller137/exportar";
        /**Ajax */
        $.ajax({
            url: varURL,
            type: 'post',
            ...
            var file_name = "137_"+$('#planta option:selected').html()+fechaFin;
            a.href = window.location.origin +"/nomina/costo137.txt";
...
var buttonCommon = {
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '#buscar', function (e) {
            ...
            Modulo.fnObtenerDatos(fechaInicio,fechaFin,empresa);
        });
