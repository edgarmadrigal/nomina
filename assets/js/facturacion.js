Modulo = {
    ...
    , fnObtenerDatos: function (fechaInicio,fechaFin) {
        ...
        var varURL = Modulo.baseurl + "facturacionController/consulta";
        /**Ajax */
        $.ajax({
            url: varURL,
            type: 'post',
    ...
    , fnConstruitTabla: function () {
        ...
        $("#facturacion").css("display", "inline-table");
...
var buttonCommon = {
    ...
    $(document).ready(function () {
        ...
        table = $('#facturacion').DataTable();
        Modulo.Init();
        $("#facturacion").dataTable().fnDestroy();
        base_url="";
        ...
        empleadosTabla=[];
            ...
            $('#facturacion tfoot th').each( function () {
                var title = $(this).text();
                if(title!="Opciones"){
            ...
            $('#facturacion thead th').each( function () {
                var title = $(this).text();
                if(title!="Opciones"){
                    $(this).html( title+'<br><input type="text" placeholder="Buscar '+title+'" />' );
                }else{
