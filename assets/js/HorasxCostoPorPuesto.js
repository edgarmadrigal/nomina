...
Modulo = {
    baseurl: "",
    //http://192.168.128.248:8080/nomina/
    validator: false,
    datosTabla: []    
    //Obtiene los datos
    , fnObtenerDatos: function (fechaInicio,fechaFin) {
        $("#HorasxCostoPorPuesto").css("display", "none");
        $(".loadTable").css("display", "block");
        var varURL = Modulo.baseurl + "HorasxCostoPorPuestoController/consulta";
        /**Ajax */
        $.ajax({
            url: varURL,
            type: 'post',
    ...
    , fnConstruitTabla: function () {
        table=$('#HorasxCostoPorPuesto').DataTable({
                ...
                "aoColumns": [
                   ...
                   },    
                   {
                       "aTargets": [2],
                       "mData": function (source, type, val) {
                           return source.puesto;
                            }
                   }, 
                   {
                       "aTargets": [3],
                       "mData": function (source, type, val) {
                           return source.empleadosporPuesto;
                            }
                   },     
                   {
                       "aTargets": [4],
                       "mData": function (source, type, val) {
                           return source.sueldo;
                            }
                   },    
                   {
                       "aTargets": [5],
                       "mData": function (source, type, val) {
                           return source.septimoProporcional;
                            }
                   },    
                   {
                       "aTargets": [6],
                       "mData": function (source, type, val) {
                           return source.horasExt;
                            }
                   },    
                   {
                       "aTargets": [7],
                       "mData": function (source, type, val) {
                           return source.horasEsp;
                            }
                   },  
                   {
                       "aTargets": [8],
                       "mData": function (source, type, val) {
                           return source.premioAsistencia;
                            }
                   },  
                   {
                       "aTargets": [9],
                       "mData": function (source, type, val) {
                           return source.premioPuntualidad;
                            }
                   }, 
                   {
                       "aTargets": [10],
                       "mData": function (source, type, val) {
                           return source.premioDesempeño;
                            }
                   },
                   {
                       "aTargets": [11],
                       "mData": function (source, type, val) {
                           return source.vacaciones;
                            }
                   },
                   {
                       "aTargets": [12],
                       "mData": function (source, type, val) {
                           return source.gratificacionFiniquito;
                            }
                   },
                   {
                       "aTargets": [13],
                       "mData": function (source, type, val) {
                           return source.incentivo;
                            }
                   },
                   {
                       "aTargets": [13],
                   ...
                   },
                   {
                       "aTargets": [14],
                       "mData": function (source, type, val) {
                           return source.horasTrab;
                            }
                   },
                   {
                       "aTargets": [15],
                       "mData": function (source, type, val) {
                           return source.horasExtra;
                            }
                   },
                   {
                       "aTargets": [16],
                       "mData": function (source, type, val) {
                           return source.horasEspeciales;
                            }
                   },
                   {
                       "aTargets": [17],
                ...
                ,buttons: [
                    ...
                    $.extend( true, {}, buttonCommon, {
                        extend: 'pdfHtml5',                        
                        orientation: 'landscape',/*'portrait', fontSize: 6,*/
                        pageSize: 'TABLOID',
        ...
        $("#HorasxCostoPorPuesto").css("display", "inline-table");
