...
Modulo = {
    ...
    , fnObtenerDatos: function (fechaInicio,fechaFin) {
        $("#percepciones").css("display", "none");
        $(".loadTable").css("display", "block");
        var varURL = Modulo.baseurl + "percepcionesController/consulta";
        /**Ajax */
        $.ajax({
            url: varURL,
            type: 'post',
    ...
    , fnConstruitTabla: function () {
        table=$('#percepciones').DataTable({
                ...
                "aoColumns": [
                   ...
                   },    
                   {
                       "aTargets": [4],
                       "mData": function (source, type, val) {
                           return source.NOMBRECONCEPTO;
                            }
                   },    
                   {
                       "aTargets": [5],
                       "mData": function (source, type, val) {
                           return source.IMPORTE_GRAVABLE;
                            }
                   },    
                   {
                       "aTargets": [6],
                       "mData": function (source, type, val) {
                           return source.IMPORTE_EXENTO;
                            }
                   },    
                   {
                       "aTargets": [7],
        ...
        $("#percepciones").css("display", "inline-table");
