...
Modulo = {
    ...
    , fnObtenerDatos: function (fechaInicio,fechaFin) {
        $("#HorasxCosto").css("display", "none");
        $(".loadTable").css("display", "block");
        var varURL = Modulo.baseurl + "HorasxCostoController/consulta";
        /**Ajax */
        $.ajax({
            url: varURL,
            type: 'post',
    ...
    , fnConstruitTabla: function () {
        table=$('#HorasxCosto').DataTable({
                ...
                "aoColumns": [
                   ...
                   },     
                   {
                       "aTargets": [3],
                       "mData": function (source, type, val) {
                           return source.horas_trab;
                            }
                   },    
                   {
                       "aTargets": [4],
                       "mData": function (source, type, val) {
                           return source.horas_ext;
                            }
                   },    
                   {
                       "aTargets": [5],
                       "mData": function (source, type, val) {
                           return source.premio;
                            }
                   },    
                   {
                       "aTargets": [6],
        ...
        $("#HorasxCosto").css("display", "inline-table");
