...
class EmpleadosController_TCT extends CI_Controller {
	...
	public function construct()
	{
		 ...
		 $this->load->model('empleadoModel_TCT');
    }
		...
		//$this->load->model('Asistencia');
		  ...
		  $data['user'] = $this->session->userdata['login']['user'];
				if ($this->session->userdata['login']['exito']) {
				  ...
				  $this->load->view('EmpleadosView_TCT', $data);
...
/**  */
	function consulta()
    {
        ...
        echo json_encode($this->empleadoModel_TCT->get_empleado($id));
    }
    ...
    public function consulta_empleado()
    {
		...
		$this->load->model('empleadoModel_TCT');
		$data =$this->empleadoModel_TCT->consulta();
    ...
    function edit()
    {
        ...
        echo $this->empleadoModel_TCT->update_empleado($id, $data);
    }
    ...
    function insert()
    {
        ...
        $dt['exito'] = $this->empleadoModel_TCT->insert_empleado($data);
        echo $dt['exito'];
    }
