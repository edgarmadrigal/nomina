...
class percepcionesNotimbradasController extends CI_Controller {
    ...
    public function index(){
      ...
      $data = [];
      $this->load->model('PercepcionesNotimbradasModel');
          if (isset($this->session->userdata['login'])) {
        $data['user'] = $this->session->userdata['login']['user'];
                    
              if ($this->session->userdata['login']['exito']) {
                $this->load->view('header', $data);
                $this->load->view('percepcionesNotimbradasView', $data);
    ...
    public function consulta(){
        ...
        $this->PercepcionesNotimbradasModel->consulta($fechaInicio,$fechaFin);

        
        
        $data=$this->PercepcionesNotimbradasModel->consultaPercepcionesNotimbradas();
