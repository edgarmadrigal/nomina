...
class HorasxCostoPorPuestoController extends CI_Controller {
    ...
    public function consulta(){
        ...
        $this->HorasxCostoPorPuestoModel->consulta($fechaInicio,$fechaFin);

        
        
       $data= $this->HorasxCostoPorPuestoModel->consultaHorasxCostoPorPuesto();
