...
class EmpleadosController_Tlahualilo extends CI_Controller {
	...
	public function construct()
	{
		 ...
		 $this->load->model('empleadoModel_Tlahualilo');
    }
		...
		//$this->load->model('Asistencia');
		  ...
		  $data['user'] = $this->session->userdata['login']['user'];
				if ($this->session->userdata['login']['exito']) {
				  ...
				  $this->load->view('EmpleadosView_Tlahualilo', $data);
...
/**  */
	function consulta()
    {
        ...
        echo json_encode($this->empleadoModel_Tlahualilo->get_empleado($id));
    }
    ...
    public function consulta_empleado()
    {
		...
		$this->load->model('empleadoModel_Tlahualilo');
		$data =$this->empleadoModel_Tlahualilo->consulta();
    ...
    function edit()
    {
        ...
        echo $this->empleadoModel_Tlahualilo->update_empleado($id, $data);
    }
    ...
    function insert()
    {
        ...
        $dt['exito'] = $this->empleadoModel_Tlahualilo->insert_empleado($data);
        echo $dt['exito'];
    }
