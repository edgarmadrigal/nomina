...
class FacturacionController extends CI_Controller {
      ...
      $this->load->model('FacturacionModel');
        ...
        $data['user'] = $this->session->userdata['login']['user'];
              ...
              if ($this->session->userdata['login']['exito']) {
                ...
                $this->load->view('FacturacionView', $data);
    ...
    public function consulta(){
        ...
        $this->load->model('FacturacionModel');
        $data= $this->FacturacionModel->consulta($fechaInicio,$fechaFin);       
        //$this->FacturacionModel->consultaFacturacion();
