...
class HorasxCostoController extends CI_Controller {
    ...
    public function consulta(){
        ...
        $this->HorasxCostoModel->consulta($fechaInicio,$fechaFin);

        
        
       $data= $this->HorasxCostoModel->consultahorasxCosto();
