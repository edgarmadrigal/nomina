...
class EmpleadosController_Leon_Guzman_Almohadas extends CI_Controller {
	...
	public function construct()
	{
		 ...
		 $this->load->model('empleadoModel_Leon_Guzman_Almohadas');
    }
		...
		//$this->load->model('Asistencia');
		  ...
		  $data['user'] = $this->session->userdata['login']['user'];
				if ($this->session->userdata['login']['exito']) {
				  ...
				  $this->load->view('EmpleadosView_Leon_Guzman_Almohadas', $data);
...
/**  */
	function consulta()
    {
        ...
        echo json_encode($this->empleadoModel_Leon_Guzman_Almohadas->get_empleado($id));
    }
    ...
    public function consulta_empleado()
    {
		...
		$this->load->model('empleadoModel_Leon_Guzman_Almohadas');
		$data =$this->empleadoModel_Leon_Guzman_Almohadas->consulta();
    ...
    function edit()
    {
        ...
        echo $this->empleadoModel_Leon_Guzman_Almohadas->update_empleado($id, $data);
    }
    ...
    function insert()
    {
        ...
        $dt['exito'] = $this->empleadoModel_Leon_Guzman_Almohadas->insert_empleado($data);
        echo $dt['exito'];
    }
