...
class EmpleadosController_Arcinas extends CI_Controller {
	...
	public function construct()
	{
		 ...
		 $this->load->model('empleadoModel_Arcinas');
    }
		...
		//$this->load->model('Asistencia');
		  ...
		  $data['user'] = $this->session->userdata['login']['user'];
				if ($this->session->userdata['login']['exito']) {
				  ...
				  $this->load->view('EmpleadosView_Arcinas', $data);
...
/**  */
	function consulta()
    {
        ...
        echo json_encode($this->empleadoModel_Arcinas->get_empleado($id));
    }
    ...
    public function consulta_empleado()
    {
		...
		$this->load->model('empleadoModel_Arcinas');
		$data =$this->empleadoModel_Arcinas->consulta();
    ...
    function edit()
    {
        ...
        echo $this->empleadoModel_Arcinas->update_empleado($id, $data);
    }
    ...
    function insert()
    {
        ...
        $dt['exito'] = $this->empleadoModel_Arcinas->insert_empleado($data);
        echo $dt['exito'];
    }
