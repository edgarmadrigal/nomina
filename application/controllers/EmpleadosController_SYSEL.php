...
class EmpleadosController_SYSEL extends CI_Controller {
	...
	public function construct()
	{
		 ...
		 $this->load->model('empleadoModel_SYSEL');
    }
		...
		//$this->load->model('Asistencia');
		  ...
		  $data['user'] = $this->session->userdata['login']['user'];
				if ($this->session->userdata['login']['exito']) {
				  ...
				  $this->load->view('EmpleadosView_SYSEL', $data);
...
/**  */
	function consulta()
    {
        ...
        echo json_encode($this->empleadoModel_SYSEL->get_empleado($id));
    }
    ...
    public function consulta_empleado()
    {
		...
		$this->load->model('empleadoModel_SYSEL');
		$data =$this->empleadoModel_SYSEL->consulta();
    ...
    function edit()
    {
        ...
        echo $this->empleadoModel_SYSEL->update_empleado($id, $data);
    }
    ...
    function insert()
    {
        ...
        $dt['exito'] = $this->empleadoModel_SYSEL->insert_empleado($data);
        echo $dt['exito'];
    }
