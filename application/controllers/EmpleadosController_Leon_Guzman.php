...
class EmpleadosController_Leon_Guzman extends CI_Controller {
	...
	public function construct()
	{
		 ...
		 $this->load->model('empleadoModel_Leon_Guzman');
    }
		...
		//$this->load->model('Asistencia');
		  ...
		  $data['user'] = $this->session->userdata['login']['user'];
				if ($this->session->userdata['login']['exito']) {
				  ...
				  $this->load->view('EmpleadosView_Leon_Guzman', $data);
...
/**  */
	function consulta()
    {
        ...
        echo json_encode($this->empleadoModel_Leon_Guzman->get_empleado($id));
    }
    ...
    public function consulta_empleado()
    {
		...
		$this->load->model('empleadoModel_Leon_Guzman');
		$data =$this->empleadoModel_Leon_Guzman->consulta();
    ...
    function edit()
    {
        ...
        echo $this->empleadoModel_Leon_Guzman->update_empleado($id, $data);
    }
    ...
    function insert()
    {
        ...
        $dt['exito'] = $this->empleadoModel_Leon_Guzman->insert_empleado($data);
        echo $dt['exito'];
    }
