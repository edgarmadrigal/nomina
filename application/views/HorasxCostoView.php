...
<div class="page-wrapper">   
    <div class="container-fluid">           
        <div class="row">
            <div class="col-12">
                <h4 class="card-title">Reporte HorasxCosto</h4> 
                <div class="card">
                    <div class="card-body">     
                        <div class="table-responsive">    
                            <div class="dataTables_wrapper dt-bootstrap4">   
                                ...
                                <div class="row" id="tablaLunes">
                                    <div class="col-12">
                                        <table id="HorasxCosto" class="display nowrap table table-hover table-striped table-bordered dataTable" style="width:100%">
                                            <thead>
                                                <tr>
                                                    <th>EMPRESA</th>
                                                    <th>PLANILLA</th>
...
<script src="assets/js/HorasxCosto.js"></script>
<script>
