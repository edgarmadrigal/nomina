...
<div class="page-wrapper">   
    <div class="container-fluid">           
        <div class="row">
            <div class="col-12">
                <h4 class="card-title">Reporte Facturas TBG</h4> 
                <div class="card">
                    <div class="card-body">     
                            ...
                            <div class="dataTables_wrapper dt-bootstrap4">   
                                ...
                                <div class="row" id="tablaLunes">
                                    <div class="col-12">
                                        ...
                                        <table id="facturacion" class="display nowrap table table-hover table-striped table-bordered dataTable" style="width:100%">
                                            <thead>
                                                <tr>                                                   
                                                    <th>FOLIO_FACTURA  </th>
                                                    <th>FECHA		   </th>
...
<!--		
Fide --- contadores ya sea humberto o Alan ó Evelyn
Darma  
Bernardo
Antonio -----de weaertex
maria perez  ----sysel
Wendy de Transportes
practicantes de comercio
Sistemas para requerimientos
-->
