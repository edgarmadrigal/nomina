...
<div class="page-wrapper">   
    <div class="container-fluid">           
        <div class="row">
            <div class="col-12">
                <h4 class="card-title">DISPERSAR CROM</h4> 
                <div class="card">
                    <div class="card-body">     
                        <!--<div class="table-responsive">    
                            <div class="dataTables_wrapper dt-bootstrap4">  --> 
                                <div class="row">                                   
                                    ...
                                    <div class="col-2">
                                        <label style="font-weight: bold!important;">FechaAplicacion</label> 
                                        <div id="datepicker3" class="input-group date" data-date-format="yyyy/mm/dd">
                                            <input id="fechaAplicacion" class="form-control" type="text" readonly />
                                            <span class="input-group-addon"><div data-icon="ei-calendar"></div></span>
                                        </div>
                                    </div>
                                    <div class="col-2">
                                    ...
                                    <div class="col-2">
                                        <div class="form-group">
                                                        <label style="font-weight: bold!important;"> &nbsp; </label><br> 
                                                        <a id="descargar" class="btn btn-info"  href="http://177.244.42.94:8080/nomina/DISPERSARCROM.txt" download>
                                                            <i class="fa fa-download"></i> Descargar fichero
                                                        </a>
                                            </div>
                                    </div>
                                ...
                                <div class="row" id="tablaLunes">
                                    <div class="col-12">
                                        <table id="costo137" class="display nowrap table table-hover table-striped table-bordered dataTable" style="width:100%">
                                            <thead>
                                                <tr>
                                                <th>CENTRO_costo137  </th>       
                                                <th>DEPARTAMENTO  </th>
                                                <th>PLANILLA	  </th>
                                                <th>PERCEP		  </th>
                                                <th>HOREXT		  </th>
...
<script src="assets/js/DISPERSARCROM.js"></script>
<script>
